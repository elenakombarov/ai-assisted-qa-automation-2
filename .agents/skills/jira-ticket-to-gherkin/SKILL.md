...
Use the Atlassian MCP server. Read tool schemas before calling.

- **Claude Code**: tool descriptors for your configured Atlassian MCP server
- **Cursor**: `mcps/plugin-atlassian-atlassian/tools/`
